				...
				<PageHeader
					title={
						origin === 'new-applicants'
							...
							: origin === 'employees'
								? dictionary?.pages?.employees?.headers?.main['title']
					...
					subtitle={
						origin === 'new-applicants'
							...
							: origin === 'employees'
								? dictionary?.pages?.employees?.headers?.main['subtitle']
								: dictionary?.pages?.former_employees?.headers?.main['subtitle']
					}
						...
						{data && data.length > 0 ? (
							data && dictionary ? (
								<DataTable
									...
									headers_dictionary={
										dictionary?.pages?.candidates?.tables?.filter_dropdown
									}
								/>
							) : null
						) : (
							<EmptyTableMessage
								title={dictionary?.pages?.candidates?.tables?.empty['title']}
								subtitle={
